        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="settingsForm_${chatter.id}" action="/updateuser" method="post">
                ...
                <br />
                <input type="password" class="form-control" id="settings_passwd" name="settings_passwd" placeholder="new Password" value="" required />
                <br />
